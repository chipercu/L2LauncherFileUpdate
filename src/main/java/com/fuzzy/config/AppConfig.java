...
public class AppConfig implements ISubsystemConfig {
    ...
    @Config(desc = "Директория проектов",
            strValue = "data/projects/") public static String PROJECTS_DIRECTORY;
    ...
    @Config(desc = "Последний выбранный проект",
            strValue = "") public static String LAST_PROJECT;
